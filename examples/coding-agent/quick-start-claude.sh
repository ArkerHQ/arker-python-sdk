...
#
# Forks ubuntu-dev and runs the Claude Code CLI inside it. A background coding
...
# claude-code is already baked into the ubuntu-dev golden — fork lands warm, no install.
