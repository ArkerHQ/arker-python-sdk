...
#
# Forks ubuntu-dev and runs the Cursor CLI inside it. A background coding agent
...
# cursor-agent is already baked into the ubuntu-dev golden — fork lands warm, no install.
